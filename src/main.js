...
const examples = {
  passed: {
    neighbor: ['LLDP DETECTED', 'pass'], switchName: 'sw-access-03.example.net', port: 'ge-0/0/24', protocol: 'LLDP', observed: 'Frame observed', note: '', summary: '4 OF 4 PASSED', result: ['CONFIGURED CONNECTIVITY CHECKS PASSED', 'pass', '✓'], tests: commonPass,
    announcement: 'Passed example displayed. Four configured connectivity checks passed and an LLDP neighbor advertisement was observed.',
  },
  partial: {
    neighbor: ['NO ADVERTISEMENT OBSERVED', 'unknown'], switchName: 'Not detected', port: 'Not detected', protocol: 'LLDP / CDP', observed: 'None observed', note: 'No LLDP/CDP advertisement was observed during this example.', summary: '2 PASSED · 1 FAILED · 1 NOT TESTED', result: ['PARTIAL RESULT — REVIEW FAILED CHECK', 'partial', '!'],
    tests: { addressing: commonPass.addressing, gateway: commonPass.gateway, dns: ['×', 'Name not resolved', 'FAIL', 'fail'], tcp: ['—', 'Dependent check not run', 'NOT TESTED', 'unknown'] },
    announcement: 'Partial example displayed. Addressing and gateway passed, DNS failed, TCP was not tested, and no neighbor advertisement was observed.',
  },
  noNeighbor: {
    neighbor: ['NO ADVERTISEMENT OBSERVED', 'unknown'], switchName: 'Not detected', port: 'Not detected', protocol: 'LLDP / CDP', observed: 'None observed', note: 'Possible reasons include LLDP/CDP being disabled, filtered, delayed, or not advertised toward the endpoint.', summary: '4 OF 4 PASSED', result: ['CONNECTIVITY CHECKS PASSED · NO NEIGHBOR OBSERVED', 'observed', '—'], tests: commonPass,
    announcement: 'No-neighbor example displayed. Four configured connectivity checks passed. No LLDP or CDP advertisement was observed; this is not labeled as a connectivity failure.',
  },
};
